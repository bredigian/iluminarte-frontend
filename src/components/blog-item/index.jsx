...
const BlogItem = ({ data, openModal }) => {
  ...
  const truncatedDescription =
    description?.length > maxLength
      ...
      : description
  return (
    <div className="blog-container__item w-[320px] h-[480px] bg-tertiary-lighter flex flex-col items-center overflow-auto rounded-[33px] shadow-xl">
