...
const AdministrationProducts = () => {
  ...
  return (
    <section className="adminstration-products flex flex-col items-center p-8">
      <div className="administration-products__items flex flex-col items-center">
        ...
        <div className="administration-products__items-container justify-center flex flex-wrap gap-4 p-8">
          {filteredProducts?.length > 0 ? (
            filteredProducts?.map((product) => {
              return (
                <ProductItem key={product.CODIGO} data={product} edit={true} />
              )
            })
          ) : (
